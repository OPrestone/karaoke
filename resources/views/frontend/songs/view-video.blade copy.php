      ...
      const player = new YT.Player('youtube-audio', {
        ...
        events: {
          onReady: function (event) {
            event.target.setVolume(70); // You can set the volume (0-100) here if desired
...
</script><div class="plyr__video-embed" id="player" style="opacity:0">
    <iframe
        id="youtubePlayer"
...
<script>
    ...
    setTimeout(showPlayer, 7000); // 5000 milliseconds = 5 seconds
</script>
