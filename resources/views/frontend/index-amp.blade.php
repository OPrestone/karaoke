...
@include('layouts.inc.amp-navbar')
  ...
  <body class="land-see">
    ...
    <section class="land-see-hero-container mx-auto mb3 relative overflow-hidden">
      ...
      <div class="land-see-hero-main mx-auto">
        <amp-carousel id="land-see-hero-main" class="land-see-hero-carousel mx-auto" media="(min-width: 40.06rem)" width="1290" height="680" layout="responsive" [slide]="selectedSlide" on="slideChange:AMP.setState({selectedSlide: event.index})" noloading="" controls="" loop="" type="slides">
         
      @foreach ($latest_posts as $post) 
      <div class="land-see-hero-content mx-auto relative">
            <amp-img class="cover land-see-hero-image land-see-cover-position-bottom" alt="Designer Kim Myeong" width="1290" height="680" layout="responsive" src="{{asset('uploads/posts/'.$post->image)}}">
            </amp-img>
            <div class="land-see-hero-typography mx-auto center z2 absolute">
              <a class="land-see-post-category land-see-page-navigation underline caps max-width-1 sm-hide md-hide lg-hide" href="{{url('amp/article/'.$post->category->slug.'/'.$post->slug)}}">Fashion</a>
              <h1 class="land-see-hero-title ampstart-title-md"><a class="text-decoration-none" href="{{url('amp/article/'.$post->category->slug.'/'.$post->slug)}}">{{$post->name}}</a></h1>
              <p class="land-see-hero-caption ampstart-caption mx-auto max-width-3 pt1 mb3">
              {{$post->meta_description}}              </p>
              <a class="land-see-hero-button text-decoration-none relative" href="{{url('amp/article/'.$post->category->slug.'/'.$post->slug)}}">Read More</a>
            </div>
          </div>
            @endforeach
    ...
    <section class="land-see-background-animation-container relative mx-auto my4">
      <a class="land-see-cta-link mx-auto" href="#">
        <amp-anim class="mt3 mb3" alt="Summer Sale!" media="(min-width: 611px)" width="813" height="342" layout="responsive" src="../img/land-see/content/summer-sale-lg.jpg">
        ...
        <amp-anim class="mt3 mb3" alt="Summer Sale!" media="(min-width: 361px) and (max-width: 610px)" width="610" height="342" layout="responsive" src="../img/land-see/content/summer-sale-md.jpg">
        ...
        <amp-anim class="mt4 mb4" alt="Summer Sale!" media="(max-width: 360px)" width="329" height="348" layout="responsive" src="../img/land-see/content/summer-sale-sm.jpg">
...
<div class="land-see-background-animation absolute max-width-3 mx-auto">
    <div class="absolute land-see-background-image-left">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 690 551" overflow="visible"><path fill="#add8bf" d="M345.048 0l-.032.051-.033-.051L0 550.606h690.031z"></path></svg>
    </div>
    <div class="absolute land-see-background-image-right">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 491 392" overflow="visible"><path fill="#fcdcd4" d="M491.354 0h-280.98v.004H0l210.374 335.771v.005l35.301 56.34.001-.001.004.006 35.3-56.34v-.015z"></path></svg>
    </div>
  <amp-position-observer on="scroll:backgroundAnimation.seekTo(percent=event.percent)" layout="nodisplay">
    ...
    <section class="land-see-recent-content relative mx-auto py4">
      ...
      <div class="clearfix pt2">
        ...
        @foreach ($most_read as $post)  
          <li class="px1 mt1 block align-top land-see-pre-animate land-see-post-item land-see-post-item-wide land-see-post-featured col land-see-recent">
            <a href="{{url('amp/article/'.$post->category->slug.'/'.$post->slug)}}" class="text-decoration-none">
                <amp-img class="land-see-post-image cover" alt="Studio Serif, interior." media="" width="409" height="305" layout="responsive" src="{{asset('uploads/posts/'.$post->image)}}">
                </amp-img>
            </a>
            <a class="land-see-post-category land-see-page-navigation inline-block pt1 underline caps" href="stories.amp.html?category&#x3D;design#land-see-design"> {{$post->category->name}} </a>
            <h4 class="land-see-post-title ampstart-title-sm pt1"><a class="text-decoration-none" href="{{url('amp/article/'.$post->category->slug.'/'.$post->slug)}}"> {{$post->name}}   </a></h4>
            <p class="ampstart-caption pt1 pb3"> {{$post->meta_description}}   </p>
          </li>
            @endforeach 
        </ul>
        <div class="absolute z4 xs-hide sm-hide land-see-recent-accent-image">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="44" height="35" viewBox="0 0 44 35" overflow="visible"><path fill="#3D6458" d="M43.535 34.74H0L21.767 0z"></path></svg>
        </div>
      </div>
    </section>
      ...
      <a class="land-see-cta-link mx-auto" href="https://www.instagram.com/lifeatgoogle/">
        <amp-anim class="mt3 mb3" alt="Instagram, follow us!" media="(min-width: 608px)" width="813" height="270" layout="responsive" src="../img/land-see/content/instagram-cta-lg.png">
          <amp-img placeholder="" alt="Instagram, follow us!" media="(min-width: 608px)" width="813" height="270" layout="responsive" src="../img/land-see/content/instagram-cta-lg.png">
          </amp-img>
        </amp-anim>
        <amp-anim class="mt3 mb3" alt="Instagram, follow us!" media="(min-width: 361px) and (max-width: 607px)" width="607" height="282" layout="responsive" src="../img/land-see/content/instagram-cta-md.png">
          <amp-img placeholder="" alt="Instagram, follow us!" media="(min-width: 361px) and (max-width: 607px)" width="607" height="282" layout="responsive" src="../img/land-see/content/instagram-cta-md.png">
          </amp-img>
        </amp-anim>
        <amp-anim class="mt4 mb4" alt="Instagram, follow us!" media="(max-width: 360px)" width="328" height="210" layout="responsive" src="../img/land-see/content/instagram-cta-sm.png">
          <amp-img placeholder="" alt="Instagram, follow us!" media="(max-width: 360px)" width="328" height="210" layout="responsive" src="../img/land-see/content/instagram-cta-sm.png">
          </amp-img>
        </amp-anim>
      </a>
...
<ul class="ampstart-social-follow list-reset flex justify-around items-center flex-wrap m0 mb4">
  ...
  <!-- End Footer -->
    ...
    @include('layouts.inc.amp-footer')