...
@section('content')  
			<main class="content">
				<div class="container-fluid p-0">
                    ...
                    <button type="submit" class="btn btn-lg btn-dark py-1 px-4">Add User</button>
					</div>
        ...
        <td>
            <div class="d-flex">
                ...
                <a href="{{url('admin/category/'.$item->id)}}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pen"></i></a>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <a type="button" class="btn btn-primary" href="{{url('admin/delete-category/'.$item->id)}}">Delete</a>
                            </div>
                        </div>
                    </div>
                </div>
