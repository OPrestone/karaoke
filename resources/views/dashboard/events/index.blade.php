...
@section('content')
			<main class="content">
				<div class="container-fluid p-0">
                    ...
                    <a href="{{url('admin/add-event')}}" class="btn btn-lg btn-dark px-4">Add Event</a>
					</div>
        ...
        <td>
            <div class="d-flex">
                <a href="{{url('admin/event/'.$item->id.'/'.$item->first_name)}}" class="btn btn-success shadow btn-xs sharp mr-1">
                    <i class="fa fa-eye"></i>
                </a>
                <a href="{{url('admin/edit-event/'.$item->id)}}" class="btn btn-primary shadow btn-xs sharp mr-1">
                    <i class="fa fa-pen"></i>
                </a>
