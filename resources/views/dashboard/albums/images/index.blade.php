...
@section('content')  
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">All albums</h1>
                    <a href="{{url('admin/add-album')}}" class="btn btn-lg btn-dark px-4">Add Event</a>
					</div>
        ...
        <tr>
            <td>{{$item->id}}</td> 
            <td>                                                
                <img src="{{asset('uploads/albums/'.$item->image)}}" class="ratio12 w-100" style="object-fit: cover;" alt="">
            </td> 
            <td>{{$item->caption}}</td>   
        <td>
            <div class="d-flex">
