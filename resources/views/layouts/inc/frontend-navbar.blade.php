...
<div id="mobile" class="demo1">
  <div class="fixed-top zindex mt-0 shadow-sm">
  ...
  <header class="topbar d-none w-100">
      <div class="mx-md-5">
        <div class="row mx-0">
          <!-- social icon-->
  ...
  <nav class="navbar navbar-expand-lg navbar-dark mx-background-top-linear p-0">
    ...
    <a class="navbar-brand" href="{{url('/')}}">
      <img src="{{ asset('assets')}}/images/download.png" class="w-75 {{ Request::is('/') ? 'd-block' : 'd-none'}} || {{ Request::is('/videos') ? 'd-block' : 'd-none'}} || {{ Request::is('iscategory/news') ? 'd-block' : ''}}" alt="" style="width: 150px !important;">
        ...
        @endforeach
        <div class="d-none post-img"> 
          <img src="{{ asset('assets')}}/images/{{$post->category->name}}.png" class="w-75 {{ Request::is('iscategory/*') ? 'd-none' : 'd-block'}}" alt="">
         </div>
...
.mx-background-top-linear {
    ...
    background: linear-gradient(76deg, #000 98%, #f9d441 98%);
}
.time{
