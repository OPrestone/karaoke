...
if(jQuery('#chartdiv').length){
    ...
    if(jQuery('#apex-radialbar-chart').length){
        var options = {
            ...
            labels: ['Apples', 'Oranges', 'Bananas', 'Berries'],
             colors: ['#E90E66', '#1ee2ac', '#ffdd31', '#00d0ff'],
    ...
    if(jQuery('#apex-pie-chart').length){
        var options = {
            ...
            colors: ['#E90E66', '#1ee2ac', '#ffdd31', '#00d0ff', '#ff7750'],
            responsive: [{
                breakpoint: 480,
                options: {
                    chart: {
    ...
    // Am Charts 
     ...
     if(jQuery('#am-simple-chart').length){
        ...
        chart.colors.list = [am4core.color("#E90E66"),];
     ...
     if(jQuery('#am-columnlinr-chart').length){
        ...
        lineSeries.stroke = am4core.color("#E90E66");
     ...
     if(jQuery('#am-polar-chart').length){
        ...
        range.axisFill.fill = am4core.color("#E90E66");
     ...
     if(jQuery('#am-polarscatter-chart').length){
        ...
        var chart = am4core.create("am-polarscatter-chart", am4charts.RadarChart);
         chart.colors.list = [am4core.color("#E90E66"),am4core.color("#1ee2ac"),am4core.color("#00d0ff")];
     ...
     if(jQuery('#am-3dpie-chart').length){
        ...
        series.colors.list = [am4core.color("#E90E66"),am4core.color("#1ee2ac"),am4core.color("#ffdd31"),
     ...
     if(jQuery('#am-layeredcolumn-chart').length){
        ...
        chart.colors.list = [am4core.color("#1ee2ac"),am4core.color("#E90E66")];
     ...
     if(jQuery('#morris-bar-chart').length){
      ...
      ykeys: ['y', 'z', 'a'],
      labels: ['Y', 'Z', 'A'],
      barColors: ['#E90E66', '#1ee2ac', '#ff7750'],
...
$(document).ready(function() {
    ...
    if(jQuery('#home-perfomer-chart').length){
        ...
        colors: ['#E90E66','#e64141','#E90E66','#00d0ff'],
        plotOptions: {
          radialBar: {
            dataLabels: {
              name: {
...
if(jQuery('#menu-chart-01').length){
       am4core.ready(function() {
        ...
        am4core.color("#3f79f1"),am4core.color("#E90E66"),am4core.color("#e64141"),am4core.color("#1ee2ac")];
  ...
  if(jQuery('#menu-chart-04').length){
    ...
    range.value = 90.4;
    range.grid.stroke = am4core.color("#E90E66");
