...
class SongController extends Controller
{
    ...
    {
        $songs = Song::whereNotNull('lyrics')->orderBy('created_at', 'DESC')->paginate(4);
    ...
    public function all()
    {
        $songs = Song::whereNotNull('lyrics')->orderBy('created_at', 'DESC')->paginate(10);
    ...
    {
        $songs = Song::whereNotNull('lyrics')->orderBy('popularity', 'DESC')->take(600)->get();
        $artists = Artist::orderBy('created_at', 'DESC')->paginate(10);
